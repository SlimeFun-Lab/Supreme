...
public class MobCollectorTools extends SlimefunItem implements Rechargeable, NotPlaceable {
  ...
  public static final ItemStack[] RECIPE_MOB_COLLECTOR_I = new ItemStack[]{null, SupremeComponents.SYNTHETIC_RUBY.asOne(), null,
      null, WeaponsBasic.AURUM_SWORD.asOne(), null, null, SlimefunItems.MEDIUM_CAPACITOR.asOne(), null};
  ...
  public static final ItemStack[] RECIPE_MOB_COLLECTOR_II = new ItemStack[]{null, SupremeCore.CORE_OF_LIFE.asOne(), null, null,
      MobCollectorTools.MOB_COLLECTOR_I.asOne(), null, null, SupremeCetrus.CETRUS_VENTUS.asOne(), null};
  ...
  public static final ItemStack[] RECIPE_MOB_COLLECTOR_III = new ItemStack[]{null, SupremeAttribute.getBomb().asOne(), null,
      null, MobCollectorTools.MOB_COLLECTOR_II.asOne(), null, null, SupremeCetrus.CETRUS_LUMIUM.asOne(), null};
  int charge;
  int maxCharge;
  ...
  public EntityInteractHandler getItemHandler() {
    return (e, item, offhand) -> {
      ...
      if (entity instanceof Bee) {
        entity.getWorld()
            .dropItemNaturally(entity.getLocation(), ItemUtil.buildItemFromMobTechDTO(BeeTech.SIMPLE_BEE, 0).asOne());
        entity.remove();
      ...
      if (entity instanceof Golem) {
        entity.getWorld()
            .dropItemNaturally(entity.getLocation(), ItemUtil.buildItemFromMobTechDTO(IronGolemTech.SIMPLE_GOLEM, 0).asOne());
        entity.remove();
        removeItemCharge(item, getCharge());
        p.playSound(p.getLocation(), Sound.BLOCK_ANVIL_FALL, 1, 1);
      }
      if (entity instanceof Zombie) {
        entity.getWorld()
            .dropItemNaturally(entity.getLocation(), ItemUtil.buildItemFromMobTechDTO(ZombieTech.SIMPLE_ZOMBIE, 0).asOne());
        entity.remove();
        removeItemCharge(item, getCharge());
        p.playSound(p.getLocation(), Sound.BLOCK_ANVIL_FALL, 1, 1);
      }
