...
public class ArmorThornium {
  ...
  public static final ItemStack[] RECIPE_THORNIUM_BOOTS = {null, null, null, SupremeCetrus.CETRUS_IGNIS.asOne(), null,
      SupremeCetrus.CETRUS_IGNIS.asOne(), SupremeComponents.THORNIUM_INGOT.asOne(), null, SupremeComponents.THORNIUM_INGOT.asOne()};
  ...
  public static final ItemStack[] RECIPE_THORNIUM_CHESTPLATE = {SupremeComponents.THORNIUM_INGOT.asOne(), null,
      SupremeComponents.THORNIUM_INGOT.asOne(), SupremeComponents.THORNIUM_INGOT.asOne(), SupremeCetrus.CETRUS_LUMIUM.asOne(),
      SupremeComponents.THORNIUM_INGOT.asOne(), SupremeComponents.THORNIUM_INGOT.asOne(), SupremeComponents.THORNIUM_INGOT.asOne(),
      SupremeComponents.THORNIUM_INGOT.asOne()};
  ...
  public static final ItemStack[] RECIPE_THORNIUM_HELMET = {SupremeComponents.THORNIUM_INGOT.asOne(), SupremeCetrus.CETRUS_AQUA.asOne(),
      SupremeComponents.THORNIUM_INGOT.asOne(), SupremeComponents.THORNIUM_INGOT.asOne(), null, SupremeComponents.THORNIUM_INGOT.asOne(), null,
      null, null};
  ...
  public static final ItemStack[] RECIPE_THORNIUM_LEGGINGS = {SupremeCetrus.CETRUS_VENTUS.asOne(),
      SupremeComponents.THORNIUM_INGOT.asOne(), SupremeCetrus.CETRUS_VENTUS.asOne(), SupremeComponents.THORNIUM_INGOT.asOne(), null,
      SupremeComponents.THORNIUM_INGOT.asOne(), SupremeComponents.THORNIUM_INGOT.asOne(), null, SupremeComponents.THORNIUM_INGOT.asOne()};
