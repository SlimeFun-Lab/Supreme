...
public class ElectricCrafter extends GenericMachine {
  ...
  public static final ItemStack[] RECIPE_ELECTRIC_CRAFTER_MACHINE = new ItemStack[]{SupremeComponents.RUSTLESS_MACHINE.asOne(),
      SlimefunItems.VANILLA_AUTO_CRAFTER.asOne(), SupremeComponents.RUSTLESS_MACHINE.asOne(), SupremeComponents.INDUCTIVE_MACHINE.asOne(),
      SupremeComponents.SYNTHETIC_RUBY.asOne(), SupremeComponents.INDUCTIVE_MACHINE.asOne(), SupremeComponents.ADAMANTIUM_PLATE.asOne(),
      SlimefunItems.ENHANCED_AUTO_CRAFTER.asOne(), SupremeComponents.ADAMANTIUM_PLATE.asOne()};
  ...
  public static final ItemStack[] RECIPE_ELECTRIC_CRAFTER_MACHINE_II = new ItemStack[]{
      SupremeComponents.CONVEYANCE_MACHINE.asOne(), SupremeComponents.BLEND_MACHINE.asOne(), SupremeComponents.CONVEYANCE_MACHINE.asOne(),
      SupremeComponents.INDUCTOR_MACHINE.asOne(), ElectricCrafter.ELECTRIC_CRAFTER_MACHINE.asOne(), SupremeComponents.INDUCTOR_MACHINE.asOne(),
      SupremeComponents.CRYSTALLIZER_MACHINE.asOne(), SupremeCetrus.CETRUS_IGNIS.asOne(), SupremeComponents.CRYSTALLIZER_MACHINE.asOne()};
  ...
  public static final ItemStack[] RECIPE_ELECTRIC_CRAFTER_MACHINE_III = new ItemStack[]{SupremeComponents.THORNERITE.asOne(),
      SupremeCetrus.CETRUS_LUX.asOne(), SupremeComponents.THORNERITE.asOne(), SupremeComponents.SUPREME.asOne(),
      ElectricCrafter.ELECTRIC_CRAFTER_MACHINE_II.asOne(), SupremeComponents.SUPREME.asOne(), SupremeComponents.CRYSTALLIZER_MACHINE.asOne(),
  ...
  public static final AbstractItemRecipe RECIPE_BATTERY = new AbstractItemRecipe(
      new ItemStack[]{SlimefunItems.ZINC_INGOT.asOne(), SlimefunItems.SULFATE.asOne(),
          SlimefunItems.COPPER_INGOT.asOne(), SlimefunItems.ZINC_INGOT.asOne(),
          SlimefunItems.SULFATE.asOne(), SlimefunItems.COPPER_INGOT.asOne(),
          new ItemStack(Material.REDSTONE), null, null}, new SlimefunItemStack(SlimefunItems.BATTERY, 1).asOne());
  ...
  public static final AbstractItemRecipe RECIPE_SYNTHETIC_AMETHYST = new AbstractItemRecipe(
      SupremeComponents.RECIPE_SYNTHETIC_AMETHYST, SupremeComponents.SYNTHETIC_AMETHYST.asOne());
  public static final AbstractItemRecipe RECIPE_SYNTHETIC_RUBY = new AbstractItemRecipe(
      SupremeComponents.RECIPE_SYNTHETIC_RUBY, SupremeComponents.SYNTHETIC_RUBY.asOne());
