...
public class SupremeCetrus {
  ...
  public static final ItemStack[] RECIPE_CETRUS_LUX = {new ItemStack(Material.FLINT, 64),
      ...
      new SlimefunItemStack(SupremeCore.CORE_OF_LIFE, 1).asOne(), new ItemStack(Material.SEA_LANTERN, 64),
  ...
  public static final ItemStack[] RECIPE_CETRUS_VENTUS = {new ItemStack(Material.FEATHER, 64),
      ...
      new ItemStack(Material.COBBLESTONE, 64), new SlimefunItemStack(SupremeCore.CORE_OF_NATURE, 1).asOne(),
  ...
  public static final ItemStack[] RECIPE_CETRUS_LUMIUM = {new ItemStack(Material.DIRT, 64),
      new SlimefunItemStack(SupremeCore.CORE_OF_BLOCK, 1).asOne(), new ItemStack(Material.GRASS_BLOCK, 64),
      new SlimefunItemStack(SupremeCore.CORE_OF_LIFE, 1).asOne(), new ItemStack(Material.OBSIDIAN, 64),
      new SlimefunItemStack(SupremeCore.CORE_OF_DEATH, 1).asOne(), new ItemStack(Material.WITHER_SKELETON_SKULL, 64),
      new SlimefunItemStack(SupremeCore.CORE_OF_ALLOY, 1).asOne(), new ItemStack(Material.NETHER_STAR, 64)};
  ...
  public static final ItemStack[] RECIPE_CETRUS_AQUA = {new ItemStack(Material.ICE, 64),
      ...
      new SlimefunItemStack(SupremeCore.CORE_OF_DEATH, 1).asOne(), new ItemStack(Material.TROPICAL_FISH, 64),
  ...
  public static final ItemStack[] RECIPE_CETRUS_IGNIS = {new ItemStack(Material.NETHERRACK, 64),
      ...
      new ItemStack(Material.QUARTZ_BLOCK, 64), new SlimefunItemStack(SupremeCore.CORE_OF_BLOCK, 1).asOne(),
